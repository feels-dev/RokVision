...
Even though code contributions are closed for a while, you can still help a lot:
1. **Bug Reports:** If you find a bug, please open an [Issue].
2. **Feature Suggestions:** Have an idea for the War Reports or Alliance Stats? Let's discuss it in the Issues!
