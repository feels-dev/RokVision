...
public class GovernorNameNeuron
{
    ...
    public string Extract(TopologyGraph graph, AnalyzedBlock? tagNode, SideLocation side, List<AnalyzedBlock> allNodes, string suffix = "")
    {
        ...
        // Attacker: Starts at 0.22 (22%) to skip the sidebar
        // Defender: Ends at 0.88 (88%) to skip right edge icons
    ...
    {
        // Cleans bracket residues but keeps international characters (per your original AllianceNeuron)
